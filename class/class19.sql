...
create or replace DATABASE DEMO_DB;
	...
	CREATE or replace STORAGE INTEGRATION azure_integration
	  ...
	  ENABLED = TRUE
	  AZURE_TENANT_ID = 'de65946d-5fc6-422f-b9ac-d1fa68448d9a' 
	  STORAGE_ALLOWED_LOCATIONS = ('azure://vitechcusdata.blob.core.windows.net/vitech-emp-data');
...
CREATE OR REPLACE stage MANAGE_DB.external_stages.csv_azure_folder
    URL = 'azure://vitechcusdata.blob.core.windows.net/vitech-emp-data'
