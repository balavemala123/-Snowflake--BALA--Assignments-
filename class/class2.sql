...
create table hr.tcs.employee (empid   number,
                       name    varchar(20),
                       address varchar(30)
                       )
...
insert into employee(empid,name,address)
            values (101,'sreekanth','BLR');
insert into employee(empid,name,address)
            values (102,'sree','Hyd');
insert into employee(empid,name,address)
            values (103,'charn','BLR');

delete from employee;

delete from employee where empid = 103

truncate table employee;  // entire table data is going to delete 

drop table employee ; // first it will delete data then table structure 
