...
SELECT * FROM OUR_FIRST_DB.public.test before (timestamp => '2024-08-16 14:50:55.871'::timestamp)
...
SELECT * FROM OUR_FIRST_DB.public.test before (statement => '01b663dd-0001-29ff-0005-4eca0002a102')
